...
const Header = () => {
  ...
  useEffect(() => {
    ...
    for (const cart of state.carts) {
      // Lặp qua từng sản phẩm trong cart và cộng dồn số lượng
  ...
  return (
    <div className="">
      <header className="shadow-md font-[sans-serif] tracking-wide  z-50 fixed top-0 left-0 right-0 ">
        <section className="md:flex lg:items-center relative py-3 lg:px-10 px-4 border-gray-200 border-b bg-white lg:min-h-[80px] max-lg:min-h-[60px]">
          <a href="" className="max-sm:w-full max-sm:mb-3 shrink-0">
            <a href="/" className="font-bold text-3xl  mb-5">
          ...
          <div className="flex flex-wrap w-full items-center">
            ...
            <div className="ml-auto max-lg:mt-4">
              <ul className="flex items-center">
                ...
                <Link to="/view-cart" className="max-lg:py-2 px-3 cursor-pointer">
